...
export default function Hero() {
  ...
  return (
    <>
      <div className="">
        <div className="lg:flex p-10 py-20 pb-0">
          <div className="w-12/12 lg:w-4/12 lg:block m-10 mb-0 text-center">
            <img
              ...
              alt="no image"
              className="inline-block w-72 m-auto"
            />
          </div>

          <div className="lg:w-8/12 w-12/12 lg:p-20 p-10 pb-0 px-0">
            <h1 className="lg:text-4xl text-3xl pb-3 font-bold text-white">
              <span className="text-slate-700">Hello I'm </span>
              MD Naiem
            </h1>
            <p className="text-slate-400 font-bold text-xl lg:text-2xl py-2">
              I am {displayText}
            </p>
        ...
        <div className="lg:p-20 py-20 p-5 pt-32 text-center">
          <div className="lg:w-3/12 w- bg-slate-900 rounded-xl shadow-xl p-5 inline-block m-5">
            ...
            <p className="text-slate-500 text-lg p-2">
              Build a website. I will make you beautifull and fast performance
              web application. I will develop in MERN stack or stack Nextjs
            </p>
            <Link
