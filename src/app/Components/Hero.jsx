    ...
    <>
      <div className="">
        <div className="lg:flex p-10 py-20">
          <div className="w-12/12 lg:block m-10 text-center">
            <img
          ...
          <div className="lg:w-8/12 w-12/12 lg:p-20 p-10 px-0">
            <h1 className="lg:text-5xl text-4xl lg:pb-10 pb-5 font-bold text-white">
          ...
          <div className="lg:p-20 py-20 p-5 pt-32 text-center">
            ...
            <div className="lg:w-3/12 w- bg-slate-900 rounded-xl shadow-xl p-5 inline-block m-5">
              ...
              <p className="text-slate-500 text-lg p-2">
                ...
                you. I will teach you from scratch and it's for absolute
                beginner.
              </p>
              <button
                onClick={commingSoon}
