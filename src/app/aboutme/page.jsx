...
export default function page() {
  return (
    <>
      <div className="lg:flex lg:p-10 p-2 pt-36 lg:justify-center">
        ...
        <div className="lg:p-10 p-5 lg:w-9/12 w-full">
          <h1
            className="lg:text-4xl text-2xl text-slate-500"
            data-aos="fade-left"
          >
            I am <span className="text-white">MD Naiem Hosen</span>
          </h1>
